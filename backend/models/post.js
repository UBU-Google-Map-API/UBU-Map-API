...
module.exports = class Post {
    ...
    static Update(name, post) {
        ...
        return db.execute('UPDATE abt SET Id = ?, Name = ?, Address = ?, Province = ?, Status = ?, Register_date = ?, Certificate_date1 = ?, Certificate_date2 = ?, Category = ?, Latitude = ?, Longitude = ?, Picture_1 = ?, Picture_2 = ?, Picture_3 = ?, Picture_4 = ?, Picture_5 = ?, Picture_6 = ?, Picture_7 = ?, Picture_8 = ?, Picture_9 = ?, Picture_10 = ?, Vdo = ? WHERE Name = ?', [post.Id, post.Name, post.Address, post.Province, post.Status, post.Register_date, post.Certificate_date1, post.Certificate_date2, post.Category, post.Latitude, post.Longitude, post.Picture_1, post.Picture_2, post.Picture_3, post.Picture_4, post.Picture_5, post.Picture_6, post.Picture_7, post.Picture_8, post.Picture_9, post.Picture_10, post.Vdo, name]);
    ...
    static SaveIMG(files) {
        console.log('File', files.Picture_1.originalname);
